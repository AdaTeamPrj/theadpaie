...
describe('Employee e2e test', () => {
  ...
  const employeeSample = { firstName: 'Paule', lastName: 'Lecomte', numeroSecuriteSociale: 'bus Picardie Br' };
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      ...
      cy.get(`[data-cy="numeroSecuriteSociale"]`).type('Concrete Berksh').should('have.value', 'Concrete Berksh');

      cy.get(`[data-cy="qualification"]`).type('Solférino').should('have.value', 'Solférino');

      cy.get(`[data-cy="tauxImposition"]`).type('16009').should('have.value', '16009');
