...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './contrat.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTRAT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTRAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTRAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTRAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTRAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTRAT actions', async () => {
      const expectedActions = [
        {
