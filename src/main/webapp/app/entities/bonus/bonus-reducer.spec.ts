...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bonus.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BONUS_LIST actions', async () => {
    ...
    it('dispatches FETCH_BONUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BONUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BONUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BONUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BONUS actions', async () => {
      const expectedActions = [
        {
