...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './employeur.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMPLOYEUR_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMPLOYEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMPLOYEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMPLOYEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMPLOYEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMPLOYEUR actions', async () => {
      const expectedActions = [
        {
