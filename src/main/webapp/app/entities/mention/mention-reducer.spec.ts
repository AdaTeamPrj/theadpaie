...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './mention.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MENTION_LIST actions', async () => {
    ...
    it('dispatches FETCH_MENTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MENTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MENTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MENTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MENTION actions', async () => {
      const expectedActions = [
        {
