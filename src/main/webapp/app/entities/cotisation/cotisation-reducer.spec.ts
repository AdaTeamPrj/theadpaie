...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COTISATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_COTISATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COTISATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COTISATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COTISATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COTISATION actions', async () => {
      const expectedActions = [
        {
