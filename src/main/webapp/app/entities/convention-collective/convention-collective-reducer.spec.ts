...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './convention-collective.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONVENTIONCOLLECTIVE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONVENTIONCOLLECTIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONVENTIONCOLLECTIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONVENTIONCOLLECTIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONVENTIONCOLLECTIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONVENTIONCOLLECTIVE actions', async () => {
      const expectedActions = [
        {
