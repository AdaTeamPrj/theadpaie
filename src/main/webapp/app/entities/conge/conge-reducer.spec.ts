...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './conge.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONGE actions', async () => {
      const expectedActions = [
        {
