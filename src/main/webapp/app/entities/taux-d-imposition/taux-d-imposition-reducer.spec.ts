...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './taux-d-imposition.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TAUXDIMPOSITION_LIST actions', async () => {
    ...
    it('dispatches FETCH_TAUXDIMPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TAUXDIMPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TAUXDIMPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TAUXDIMPOSITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TAUXDIMPOSITION actions', async () => {
      const expectedActions = [
        {
