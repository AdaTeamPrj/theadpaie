...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FICHEDEPAIE_LIST actions', async () => {
    ...
    it('dispatches FETCH_FICHEDEPAIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FICHEDEPAIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FICHEDEPAIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FICHEDEPAIE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FICHEDEPAIE actions', async () => {
      const expectedActions = [
        {
